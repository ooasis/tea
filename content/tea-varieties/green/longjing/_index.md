...
{{< img src="longjing-1.png" w="1200x" alt="West Lake Longjing (Xihu Longjing) illustration" >}}
...
According to legend, the **Emperor Qianlong** visited West Lake and was so impressed by the tea at Shifeng (Lion Peak) Mountain that he granted "Imperial" status to 18 tea bushes. Some gardens still point to "imperial bushes" associated with this story.
...
1. **Lion (Shi Feng):** The most prestigious. Known for a yellowish-green color and a "high" aroma.
2. **Dragon (Longjing Village):** The namesake of the tea.
3. **Cloud (Yunqi):** Known for a refreshing, cooling taste.
4. **Tiger (Hupao):** Named after the famous Tiger Spring (it is said that Tiger Spring water + Longjing tea is the perfect match).
5. **Plum (Meijiawu):** The largest production area, known for its beautiful jade-green color.
...
> **Pro Tip:** Look for the **Geographical Indication (GI) sticker** on the tin. Authentic West Lake Longjing often comes with a QR code or scratch-off serial number that can help verify it was produced within the protected Hangzhou zone.
